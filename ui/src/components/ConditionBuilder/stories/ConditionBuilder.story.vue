...
import ModalDepth from "./ModalDepth.vue";
...
const demos = [
	...
	{
		title: "Modal depth",
		description: "Where deep nesting escapes into a dialog.",
		component: ModalDepth,
	},
	{
		title: "Frappe format",
	...
	{
		title: "States",
		description: "Empty, null, read-only, disabled, every control, raw entries.",
		component: States,
	},
	{
		title: "Minimal",
